...
if ($badging -notmatch "versionCode='400'") { throw 'Final APK versionCode mismatch' }
if ($badging -notmatch "versionName='2\.0\.2-android-v4'") { throw 'Final APK versionName mismatch' }
