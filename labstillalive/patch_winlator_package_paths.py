...
for archive in sorted(ASSETS.rglob("*.tzst")):
    with tempfile.TemporaryDirectory(prefix="lab-pathpatch-") as tmp:
        tmpdir = Path(tmp)
...
# Pinned Winlator 11.2 contains 458 byte occurrences in compressed assets
...
print("package_path=/data/data/com.harekuto")
